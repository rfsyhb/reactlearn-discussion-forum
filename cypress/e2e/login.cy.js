 ...
 */
describe('Login spec', () => {
  // memastikan tidak ada duplikasi kode cy.visit maka gunakan beforeEach
  beforeEach(() => {
  ...
  it('should display login page correctly', () => {
    ...
    cy.get('button')
      .contains(/^Login$/) // memastikan nama sesuai string
      .should('be.visible');
  });
  ...
  it('should display alert when email is not valid', () => {
    ...
    // klik tombol login dengan email yang tidak ssah
    cy.get('button')
      .contains(/^Login$/)
      .click();
  ...
  it('should display homepage when email and password are correct', () => {
    // mengisi email
    cy.get('input[placeholder="Email"]').type('capibara@gmail.com');

    // mengisi password
    cy.get('input[placeholder="Password"]').type('capibara');
